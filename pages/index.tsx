  ...
  return (
    <motion.div className="flex flex-col flex-grow px-6 pt-1" variants={routeAnimation} initial="initial" animate="animate" exit="exit">
      <h6 className="my-3 text-base font-medium">
         Hi, I'm Gabriela, a passionate developer.
        I love creating applications and learning new technologies. In 2021 I did a programming bootcamp of more than 800 hours to specialize in web development.
      </h6>
      <h6><span>I'm hard working, super curious, committed and a fast learner!</span></h6>
      <div
