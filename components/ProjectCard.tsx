...
const ProjectCard:React.FC <{project:IProject, setShowDetail:(id:null|number)=>void, showDetail:number|null}> = 
({project: {name,category,deployed_url,description,github_url,image_path,key_techs, id},
showDetail,
setShowDetail}) => {
    return (
        <div>
